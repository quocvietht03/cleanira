...
<div class="bt-product-sidebar">
  <form class="bt-product-filter-form" action="" method="get">
    <div class="bt-form-action">
      ...
      <div class="bt-form-button">
        <a href="#" class="bt-reset-btn disable">
          <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 512 512" fill="#212121">
    ...
    <div class="bt-product-filter-fields">
      ...
      <?php
      $field_name = __('Product Categories', 'cleanira');
      $field_value = (isset($_GET['product_cat'])) ? $_GET['product_cat'] : '';
      cleanira_product_field_radio_html('product_cat', $field_name, $field_value);
      $field_title = __('Price', 'cleanira');
      $field_min_value = (isset($_GET['min_price'])) ? $_GET['min_price'] : '';
      $field_max_value = (isset($_GET['max_price'])) ? $_GET['max_price'] : '';
      cleanira_product_field_price_slider($field_title, $field_min_value, $field_max_value);
      $field_name = __('Brand', 'cleanira');
      $field_value = (isset($_GET['product_brand'])) ? $_GET['product_brand'] : '';
      cleanira_product_field_multiple_html('product_brand', $field_name, $field_value);
      $field_name = __('Customer Rating', 'cleanira');
      $field_value = (isset($_GET['product_rating'])) ? $_GET['product_rating'] : '';
      cleanira_product_field_rating('product_rating', $field_name, $field_value);
      ?>
    </div>
  </form>
</div>
