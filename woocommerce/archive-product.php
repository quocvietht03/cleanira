					...
					<div class="bt-products-topbar">
						<div class="bt-product-action">
							<div class="bt-product-sidebar-toggle">
								...
								</svg><?php esc_html_e('Filters', 'cleanira') ?>
							</div>
						...
						<div class="bt-product-orderby">
							<div class="bt-product-sort-block">
								<span class="bt-sort-title">
									<?php echo esc_html__('Sort by:', 'cleanira'); ?>
								</span>
								<div class="bt-sort-field">
									<?php
									$sort_options = array(
										'date_high' => esc_html__('Date: newest first', 'cleanira'),
										'date_low' => esc_html__('Date: oldest first', 'cleanira'),
										'best_selling' => esc_html__('Best Selling', 'cleanira'),
										'average_rating' => esc_html__('Average Rating', 'cleanira'),
										'price_high' => esc_html__('Price: highest first', 'cleanira'),
										'price_low' => esc_html__('Price: lower first', 'cleanira')
									);
									?>
					...
					<span class="bt-loading-wave"></span>
						...
						?>
							...
							<div class="bt-product-pagination-wrap">
								<?php echo cleanira_product_pagination($current_page, $total_page); ?>
							</div>
						<?php
						} else {
							echo '<h3 class="not-found-post">' . esc_html__('Sorry, No products found', 'cleanira') . '</h3>';
						}
