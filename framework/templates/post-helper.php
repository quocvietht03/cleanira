<?php
/* Count post view. */
if (!function_exists('cleanira_set_count_view')) {
  function cleanira_set_count_view()
  {
    $post_id = get_the_ID();

    if (is_single() && !empty($post_id) && !isset($_COOKIE['cleanira_post_view_' . $post_id])) {
      ...
      /* set cookie. */
      setcookie('cleanira_post_view_' . $post_id, $post_id, time() * 20, '/');
    }
  }
}
add_action('wp', 'cleanira_set_count_view');

/* Post count view */
if (!function_exists('cleanira_get_count_view')) {
  function cleanira_get_count_view()
  {
    $post_id = get_the_ID();
    $views = get_post_meta($post_id, '_post_count_views', true);

    $views = $views ? $views : 0;
    $label = $views > 1 ? esc_html__('Views', 'cleanira') : esc_html__('View', 'cleanira');
    return $views . ' ' . $label;
  }
}

/* Post Reading */
if (!function_exists('cleanira_reading_time_render')) {
  function cleanira_reading_time_render()
  {
...
/* Single Post Title */
if (!function_exists('cleanira_single_post_title_render')) {
  function cleanira_single_post_title_render()
  {
    ob_start();
?>
...
/* Post Title */
if (!function_exists('cleanira_post_title_render')) {
  function cleanira_post_title_render()
  {
    ob_start();
  ?>
    <h3 class="bt-post--title">
...
/* Post Featured */
if (!function_exists('cleanira_post_featured_render')) {
  function cleanira_post_featured_render($image_size = 'full')
  {
    ob_start();
...
/* Post Cover Featured */
if (!function_exists('cleanira_post_cover_featured_render')) {
  function cleanira_post_cover_featured_render($image_size = 'full')
  {
    ob_start();
    ?>
    <div class="bt-post--featured">
...
/* Post Publish */
if (!function_exists('cleanira_post_publish_render')) {
  function cleanira_post_publish_render()
  {
    ob_start();
...
/* Post Short Meta */
if (!function_exists('cleanira_post_short_meta_render')) {
  function cleanira_post_short_meta_render()
  {
    ob_start();
...
/* Post Meta */
if (!function_exists('cleanira_post_meta_render')) {
  function cleanira_post_meta_render()
  {
    ob_start();
      ...
      <ul class="bt-post--meta">
        ...
        <li class="bt-meta bt-meta--view">
          <a href="<?php echo get_the_permalink(); ?>">
            ...
            <?php echo cleanira_get_count_view(); ?>
          </a>
        </li>
        ...
        <li class="bt-meta bt-meta--comment">
          <a href="<?php comments_link(); ?>">
            ...
            <?php comments_number(esc_html__('0 Comments', 'cleanira'), esc_html__('1 Comment', 'cleanira'), esc_html__('% Comments', 'cleanira')); ?>
          </a>
        </li>
      </ul>
      <?php
      echo cleanira_share_render();
      ?>
    </div>
    <?php
    return ob_get_clean();
...
/* Post Category */
if (!function_exists('cleanira_post_category_render')) {
  function cleanira_post_category_render()
  {
    $post_id = get_the_ID();
...
/* Post Content */
if (!function_exists('cleanira_post_content_render')) {
  function cleanira_post_content_render()
  {
    ...
    ?>
      <div class="bt-post--content">
        ...
        the_content();
        wp_link_pages(array(
          'before' => '<div class="page-links">' . esc_html__('Pages:', 'cleanira'),
          'after' => '</div>',
        ));
        ?>
      </div>
...
/* Post tag */
if (!function_exists('cleanira_tags_render')) {
  function cleanira_tags_render()
  {
    ob_start();
    if (has_tag()) {
    ?>
...
/* Post share */
if (!function_exists('cleanira_share_render')) {
  function cleanira_share_render()
  {
    ...
    <?php } elseif (!empty($social_item)) { ?>
      ...
      <div class="bt-post-share">
        <span><?php echo esc_html__('Share: ', 'cleanira'); ?></span>
...
/* Post Button */
if (!function_exists('cleanira_post_button_render')) {
  function cleanira_post_button_render($text)
  { ?>
...
/* Book Now Button */
if (!function_exists('cleanira_service_button_book_now_render')) {
  function cleanira_service_button_book_now_render($text)
  {
...
/* Author Icon */
if (!function_exists('cleanira_author_icon_render')) {
  function cleanira_author_icon_render()
  { ?>
    <div class="bt-post-author-icon">
      ...
      <h4 class="bt-post-author-icon--name"> <?php echo esc_html__('By', 'cleanira') . ' ' . get_the_author(); ?> </h4>
    </div>
  <?php }
}
...
/* Related posts */
if (!function_exists('cleanira_related_posts')) {
  function cleanira_related_posts()
  {
    $post_id = get_the_ID();
    $cat_ids = array();
    ...
    ?>
      <div class="bt-related-posts">
        <div class="bt-related-posts--heading">
          <h4 class="bt-sub"><?php esc_html_e('From The Blog', 'cleanira'); ?></h4>
          <h2 class="bt-head"><?php esc_html_e('Related News ', 'cleanira'); ?><span><?php esc_html_e('& Articles', 'cleanira'); ?></span></h2>
        </div>
...
//Comment Field Order
function cleanira_comment_fields_custom_order($fields)
{
...
add_filter('comment_form_fields', 'cleanira_comment_fields_custom_order');

/* Custom comment list */
if (!function_exists('cleanira_custom_comment')) {
  function cleanira_custom_comment($comment, $args, $depth)
  {
      ...
      <div class="bt-comment">
        ...
        <div class="bt-content">
          ...
          <?php if ($comment->comment_approved == '0') : ?>
            <em class="comment-awaiting-moderation"><?php esc_html_e('Your comment is awaiting moderation.', 'cleanira'); ?></em>
          <?php endif; ?>
          <div class="bt-text">
            <?php comment_text(); ?>
          </div>
