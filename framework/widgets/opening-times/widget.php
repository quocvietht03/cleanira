<?php
namespace CleaniraElementorWidgets\Widgets\OpeningTime;
...
class Widget_OpeningTime extends Widget_Base
{
    ...
    {
        return __('Opening Time', 'cleanira');
    }
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->add_control(
			'label_style',[
				'label' => esc_html__( 'Label', 'cleanira' ),
        ...
        $this->add_control(
			'value_style',[
				'label' => esc_html__( 'Value', 'cleanira' ),
				'type'  => Controls_Manager::HEADING,
			]
		);
    ...
    protected function render()
    {
        ...
        <div class="bt-opening-times--default">
            <div class="bt-opening-times--label"><?php echo esc_html__('Opening Times:', 'cleanira'); ?></div>
            <?php
