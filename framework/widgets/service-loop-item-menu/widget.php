...
namespace CleaniraElementorWidgets\Widgets\ServiceLoopItemMenu;
...
class Widget_ServiceLoopItemMenu extends Widget_Base
{
	...
	{
		return __('Service Loop Item - Menu', 'cleanira');
	}
	...
	protected function register_style_section_controls()
	{
		...
		$this->add_control(
			'background_content',
			[
				'label' => esc_html__('Background Content', 'cleanira'),
		...
		$this->add_control(
			'title_color_hover',
			[
				'label' => esc_html__('Color Hover', 'cleanira'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'service_excerpt',
			[
				'label' => esc_html__('Service Excerpt', 'cleanira'),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Excerpt Color', 'cleanira'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
