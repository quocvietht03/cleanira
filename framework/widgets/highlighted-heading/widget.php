...
namespace CleaniraElementorWidgets\Widgets\HighlightedHeading;
...
class Widget_HighlightedHeading extends Widget_Base
{
	...
	{
		return __('Highlighted Heading', 'cleanira');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'before_text',
			[
				'label'       => esc_html__('Before Text', 'cleanira'),
		...
		$this->add_control(
			'highlighted_text',
			[
				'label'       => esc_html__('Highlighted Text', 'cleanira'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => esc_html__('Highlighted', 'cleanira'),
			]
		);
		...
		$this->add_control(
			'after_text',
			[
				'label'       => esc_html__('After Text', 'cleanira'),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => '',
			]
