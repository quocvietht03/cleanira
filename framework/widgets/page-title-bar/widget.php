...
namespace CleaniraElementorWidgets\Widgets\PageTitleBar;
...
class Widget_PageTitleBar extends Widget_Base
{
	...
	{
		return __('Page Title Bar', 'cleanira');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'custom_title_blurry',
			[
				'label' => __('Custom Title Blurry', 'cleanira'),
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->add_control(
			'title_blurry_style',
			[
				'label' => __('Title Blurry', 'cleanira'),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Blurry Title Typography', 'cleanira'),
				'default' => '',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Breadcrumb Typography', 'cleanira'),
				'default' => '',
	...
	protected function render()
	{
		...
		$home_text = esc_html__('Home', 'cleanira');
		$delimiter = '|';
?>
