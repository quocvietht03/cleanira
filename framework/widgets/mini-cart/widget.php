...
namespace CleaniraElementorWidgets\Widgets\MiniCart;
...
class Widget_MiniCart extends Widget_Base
{
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'cart_mini_icon',
			[
				'label' => esc_html__('Icon Cart', 'cleanira'),
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Content Cart', 'cleanira'),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('number_cart Typography', 'cleanira'),
				'default' => '',
