...
namespace CleaniraElementorWidgets\Widgets\HighlightedHeadingStyle1;
...
class Widget_HighlightedHeadingStyle1 extends Widget_Base
{
	...
	{
		return __('Highlighted Heading Style 1', 'cleanira');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => __('Text Heading', 'cleanira'),
			]
		);
		$repeater->add_control(
			'style_title',
			[
				'label' => __('Style', 'cleanira'),
		...
		$this->add_control(
			'list',
			[
				'label' => __('List Style Heading', 'cleanira'),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'text_title' => __('This is the heading', 'cleanira'),
						'style_title' => '1'
					],
					[
						'text_title' => __('Highlighted', 'cleanira'),
						'style_title' => '2'
					],
					[
						'text_title' => __('After heading', 'cleanira'),
						'style_title' => '1'
					],
				],
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->add_control(
			...
			[
				'label' => __('Highlighted Text', 'cleanira'),
