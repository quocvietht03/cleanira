<?php
namespace CleaniraElementorWidgets\Widgets\ServiceLoopItem;
...
class Widget_ServiceLoopItem extends Widget_Base {
	...
	public function get_title() {
		return __( 'Service Loop Item', 'cleanira' );
	}
	...
	protected function register_style_section_controls() {
		...
		$this->add_control(
			'background_box',[
				'label'     => esc_html__( 'Background Box', 'cleanira' ),
		...
		$this->add_control(
			'overlay_image',[
				'label'     => esc_html__( 'Overlay Image Color', 'cleanira' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
