...
namespace CleaniraElementorWidgets\Widgets\PricingItemStyle1;
...
class Widget_PricingItemStyle1 extends Widget_Base
{
	...
	{
		return __('Pricing Item Style1', 'cleanira');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__('/Month', 'cleanira'),
			]
		);
		$this->add_control(
			'time',
		...
		$this->add_control(
			'description_info',
			[
				'label' => esc_html__('Description Info', 'cleanira'),
		...
		$repeater->add_control(
			'list_strikethrough',
			[
				'label' => __('Enable Strikethrough', 'cleanira'),
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'list_content' => esc_html__('Face masks', 'cleanira'),
						'list_strikethrough' => 'no',
					],
					[
						'list_content' => esc_html__('Geothermal Spa', 'cleanira'),
						'list_strikethrough' => 'no',
					],
					[
						'list_content' => esc_html__('Aroma therapy', 'cleanira'),
						'list_strikethrough' => 'no',
					],
				],
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->add_control(
			...
			[
				'label' => __('Background Overlay Image', 'cleanira'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Background Images', 'cleanira'),
				'type' => Controls_Manager::MEDIA,
				'default' => [
					'url' => '',
				],
		...
		$this->add_control(
			...
			[
				'label' => __('Description Info', 'cleanira'),
				'type' => Controls_Manager::HEADING,
			]
		);
		$this->add_control(
			'description_color',
			[
				'label' => __('Description Color', 'cleanira'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'info_icon_color',
			[
				'label' => __('Icon Info Color', 'cleanira'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'info_color',
			[
				'label' => __('Text Info Color', 'cleanira'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __('Button More Wrap Color', 'cleanira'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
