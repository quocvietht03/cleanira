<?php
namespace CleaniraElementorWidgets\Widgets\PopularServicesStyle1;
...
class Widget_PopularServicesStyle1 extends Widget_Base
{
	...
	{
		return __('Popular Services Style 1', 'cleanira');
	}
	...
	protected function register_style_section_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Background Overlay', 'cleanira'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
