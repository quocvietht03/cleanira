...
namespace CleaniraElementorWidgets\Widgets\SiteBoxPhone;
...
class Widget_SiteBoxPhone extends Widget_Base
{
	...
	{
		return __('Site Box Phone', 'cleanira');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'phone_custom_enable',
			[
				'label' => __('Enable Custom', 'cleanira'),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => esc_html__('Chat Us Anytime', 'cleanira'),
				'condition' => [
					'phone_custom_enable' => 'yes',
				],
			]
		...
		$this->add_control(
			'phone',
			[
				'label' => esc_html__('Phone', 'cleanira'),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => '',
				'condition' => [
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->start_controls_section(
			'section_style',
			[
				'label' => esc_html__('Content Box', 'cleanira'),
		...
		$this->add_responsive_control(
			'content_gap',
			[
				'label' => __('Content Spacing', 'cleanira'),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 8,
				],
			...
			<div class="bt-site-box-phone">
				...
				?>
					<a href="<?php echo esc_url('tel:' . preg_replace('/[^0-9]+/', '', $site_information['site_phone'])); ?>">
						...
						<div class="bt-site-box-phone--infor">
							<?php
							echo '<div class="bt-label">' . esc_html__('Chat Us Anytime', 'cleanira') . '</div>';
							?>
							<?php
