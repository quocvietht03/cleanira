...
namespace CleaniraElementorWidgets\Widgets\BrandSlider;
...
class Widget_BrandSlider extends Widget_Base
{
    ...
    {
        return __('Brand Slider', 'cleanira');
    }
    ...
    protected function register_style_section_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Slider', 'cleanira'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'slider_auto',
            [
                'label' => __('Slider Item Auto', 'cleanira'),
        ...
        $this->add_control(
            'slider_speed',
            [
                'label' => __('Slider Speed', 'cleanira'),
                'type' => Controls_Manager::NUMBER,
                'default' => 5000,
            ]
        );
        $this->add_control(
            'slider_spacebetween',
            [
                'label' => __('Slider SpaceBetween', 'cleanira'),
                'type' => Controls_Manager::NUMBER,
                'default' => 10,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Background Blur', 'cleanira'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
