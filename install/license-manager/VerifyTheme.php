...
if ( ! class_exists( 'VerifyTheme_Admin' ) ) {
  ...
  class VerifyTheme_Admin {
      ...
      public static function enqueue_admin_assets( $hook ) : void {
          ...
          wp_localize_script(
              ...
              [
                  ...
                  'strings'  => [
                      'confirm_import'            => __( 'Please activate the Theme License to unlock Demo Import, Plugin updates, and Official Support.', 'cleanira' ),
                      'deactivate_confirm'        => __( 'Are you sure you want to deregister this license on this site?', 'cleanira' ),
                      'please_enter_purchase_code'=> __( 'Please enter a purchase code.', 'cleanira' ),
                      'ajax_error'                => __( 'AJAX error. Please try again.', 'cleanira' ),
                      'verifying'                 => __( 'Verifying...', 'cleanira' ),
                      'processing'                => __( 'Processing...', 'cleanira' ),
                      'license_activated'         => __( 'License activated.', 'cleanira' ),
                      'license_deactivated'       => __( 'License deactivated.', 'cleanira' ),
                      'activation_failed'         => __( 'Activation failed.', 'cleanira' ),
                      'deactivation_failed'       => __( 'Deactivation failed.', 'cleanira' ),
                      'too_many_attempts'         => __( 'Too many attempts. Try again later.', 'cleanira' ),
                      'unauthorized'              => __( 'Unauthorized', 'cleanira' ),
                  ],
              ]
          );
      }
      ...
      public static function render_admin_page() : void {
          ...
          ?>
          <div class="wrap">
              <h1><?php esc_html_e( 'Envato Settings', 'cleanira' ); ?></h1>
              <p>
                <?php esc_html_e( 'Enter your Envato purchase code to activate the theme on this domain.', 'cleanira' ); ?>
                <?php esc_html_e('Find instructions on obtaining Envato discount codes by ', 'cleanira'); ?>
                <a href="<?php echo esc_url('https://docs.beplusthemes.com/ProductRegistration/'); ?>" target="_blank"><?php esc_html_e('clicking here.', 'cleanira'); ?></a>
              </p>

              <?php if ( $is_activated ) : ?>
                  <div class="notice notice-success"><p>
                      <?php printf( esc_html__( 'License activated on: %s', 'cleanira' ), esc_html( $domain ) ); ?>
                  </p></div>
              <?php endif; ?>

              <table class="form-table">
                  <tr>
                      <th scope="row"><label for="verify_purchase_code"><?php esc_html_e( 'Purchase code', 'cleanira' ); ?></label></th>
                      <td>
                          ...
                          <p class="description"><?php esc_html_e( 'Enter purchase code and click Activate.', 'cleanira' ); ?></p>
                      </td>
                  </tr>
              </table>
