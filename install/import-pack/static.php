...
if( ! function_exists( 'cleanira_import_pack_scripts' ) ) {
    /**
     * Import pack load scripts
     *
     */
    function cleanira_import_pack_scripts() {
        ...
        wp_localize_script( 'import-pack-js', 'import_pack_php_data', [
             ...
             * security
             */
            'template_nonce'    => wp_create_nonce( 'cleanira_template_nonce' ),
            'callback_nonce'    => wp_create_nonce( 'cleanira_callback_nonce' ),
            'download_package_nonce'  => wp_create_nonce( 'cleanira_download_package_nonce' ),
            'extract_package_nonce'  => wp_create_nonce( 'cleanira_extract_package_nonce' ),
            'restore_data_nonce'  => wp_create_nonce( 'cleanira_restore_data_nonce' ),
            'backup_site_nonce'  => wp_create_nonce( 'cleanira_backup_site_nonce' ),
    ...
    add_action( 'admin_enqueue_scripts', 'cleanira_import_pack_scripts' );
}
