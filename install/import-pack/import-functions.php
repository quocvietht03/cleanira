...

{
    ...
    function cleanira_import_pack_defineds() {
        ...
        define( 'IMPORT_REMOTE_SERVER', 'https://package.beplusthemes.com/cleanira/' );
...
if( ! function_exists( 'cleanira_register_import_menu' ) ) {
    /**
    ...
    function cleanira_register_import_menu() {
        ...
        add_submenu_page(
            ...
            'manage_options',
            'import-demo-page',
            'cleanira_register_import_page_callback'
        );
    }
}

if( ! function_exists( 'cleanira_register_import_page_callback' ) ) {
    /**
    ...
    function amentex_import_page_tabs() {
        ...
        return apply_filters( 'cleanira/import_page/tabs', [
            [
                ...
                'template_callback' => 'cleanira_import_pack_demo_install_package_tab_content',
            ],
            [
                'id' => 'theme_requirements',
                'title' => __( 'Theme Requirements', 'cleanira' ),
                'template_callback' => 'cleanira_import_pack_theme_requirements_tab_content',
            ],
        ] );
    }
}

if( ! function_exists( 'cleanira_package_demo' ) ) {
    /**
     * Import package demo data
     *
     */
    function cleanira_package_demo() {

        return require( get_template_directory() . '/install/import-pack/data/import.php' );
    }
}

if( ! function_exists( 'cleanira_import_pack_theme_requirements_tab_content' ) ) {
    /**
     * Import pack theme requirements template
     *
     */
    function cleanira_import_pack_theme_requirements_tab_content() {

        load_template( get_template_directory() . '/install/import-pack/templates/theme-requirements.php' );
    }
}

if( ! function_exists( 'cleanira_import_pack_demo_install_package_tab_content' ) ) {
    /**
     * Import pack demo install package template
     *
     */
    function cleanira_import_pack_demo_install_package_tab_content() {

        set_query_var( 'package_demos', cleanira_package_demo() );
        load_template( get_template_directory() . '/install/import-pack/templates/demo-install-package.php' );
    }
}

if( ! function_exists( 'cleanira_import_pack_get_package_data_by_id' ) ) {
    /**
     * Get package data by package name
     *
     */
    function cleanira_import_pack_get_package_data_by_id( $package_id ) {

        $packages = cleanira_package_demo();
...
if( ! function_exists( 'cleanira_import_pack_import_steps' ) ) {
    /**
     * Import steps define
     *
     */
    function cleanira_import_pack_import_steps() {
        ...
        return apply_filters( 'cleanira/import_pack/import_steps', [
            [
                ...
                'description' => __( 'Avoid risks during the import process, you should create a backup before performing install package demo. click \'yes\' to backup now or skip.', 'cleanira' ),
                'template_callback' => 'cleanira_import_pack_step_backup_site',
                'actions' => ['__skip__', '__yes__'],
                'actions_callback' => [
                    [
                        'action' => '__skip__',
                        'ajax_func' => 'cleanira_import_pack_backup_site_skip_func',
                    ],
                ]
            ],
            // [
            ...
            [
                ...
                'description' => __( 'This process may take several minutes or longer depending on the network speed. Thanks you!', 'cleanira' ),
                'template_callback' => 'cleanira_import_pack_step_download_import_package',
                'actions' => ['__yes__'],
            ],
            [
                'name' => 'import_package_successful',
                'title' => __( 'Import Package Successful!', 'cleanira' ),
                'description' => __( 'Thank you creating with Cleanira. Do not hesitate to contact us if you need help!', 'cleanira' ),
                'template_callback' => 'cleanira_import_pack_step_import_package_successful',
            ]
        ] );
    }
}

if( ! function_exists( 'cleanira_import_pack_step_import_package_successful' ) ) {
    /**
     * Step import package successful
     */
    function cleanira_import_pack_step_import_package_successful( $package, $step, $index ) {
        ?>
...
if( ! function_exists( 'cleanira_import_pack_render_actions_button' ) ) {
    /**
...
if( ! function_exists( 'cleanira_import_pack_render_actions_callback_form' ) ) {
    /**
     * Render action handle form
     *
     */
    function cleanira_import_pack_render_actions_callback_form( $actions_callback = [] ) {
...
if( ! function_exists( 'cleanira_import_pack_step_backup_site' ) ) {
    /**
     * Step backup site
     *
     */
    function cleanira_import_pack_step_backup_site( $package, $step, $index ) {
        $int_step = $index + 1;
        ?>
        <div class="item inner-step">
            <div class="heading-image">
                    ...
                    <div class="ip-explained-content">
                        <ul class="__sub-step">
                            <li class="__step" data-step-name="install_bears_backup_plg">
                                <span class="__step-label"><?php _e( 'Install Bears Backup Plugin', 'cleanira' ); ?></span>
                                <span class="status-ui"></span>
                            </li>
                            <li class="__step" data-step-name="backup_database">
                                <span class="__step-label"><?php _e( 'Backup Database', 'cleanira' ); ?></span>
                                <span class="status-ui"></span>
                            </li>
                            <li class="__step" data-step-name="create_file_config">
                                <span class="__step-label"><?php _e( 'Create File Config', 'cleanira' ); ?></span>
                                <span class="status-ui"></span>
                            </li>
                            <li class="__step" data-step-name="backup_folder_upload">
                                <span class="__step-label"><?php _e( 'Backup Folder Upload', 'cleanira' ); ?></span>
                                <span class="status-ui"></span>
                            </li>
                        </ul>
                    </div>
...
if( ! function_exists( 'cleanira_import_pack_step_download_import_package' ) ) {
    /**
     * Step download & import demo
     *
     */
    function cleanira_import_pack_step_download_import_package( $package, $step, $index ) {
        $int_step = $index + 1;
        ?>
        <div class="item inner-step">
            <div class="heading-image">
...
if( ! function_exists( 'cleanira_import_pack_backup_site_skip_func' ) ) {
    /**
     * Backup site skip action
     *
     */
    function cleanira_import_pack_backup_site_skip_func() {
...
if( ! function_exists( 'cleanira_import_pack_backup_site_yes_func' ) ) {
    /**
     * Backup site yes action
     */
    function cleanira_import_pack_backup_site_yes_func() {
...
if( ! function_exists( 'cleanira_import_pack_download_package_step' ) ) {
    ...
    function cleanira_import_pack_download_package_step( $package_name, $position = 0, $package = null ) {
        ...
        if( ! $position ) {
            ...
            $result = cleanira_import_pack_download_package_step_init( $remote_url, 'package-demo.zip' );
        } else {

            $result = cleanira_import_pack_download_package_step_push( $remote_url, $position, $package );
        }
...
if( ! function_exists( 'cleanira_import_pack_download_package_step_init' ) ) {
    /**
     * Create package file (.zip)
     *
     */
    function cleanira_import_pack_download_package_step_init( $remote_url, $file_name ) {
        ...
        $head = cleanira_import_pack_read_remote_head( $remote_url );
...
if( ! function_exists( 'cleanira_import_pack_download_package_step_push' ) ) {
    /**
     * Download package push data
     *
     */
    function cleanira_import_pack_download_package_step_push( $remote_url, $position, $package ) {
